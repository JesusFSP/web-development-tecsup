            ...
            return (
              ...
              >
                ...
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <a href={`https://api.whatsapp.com/send?phone=51924112585&text=Mascota: ${petName}; ${date} ${hour}; Síntomas: ${symptoms}; Dueño: ${ownerName}`} target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-sm">Confirmar</a>
                </div>
              </li>
            );
          })}
